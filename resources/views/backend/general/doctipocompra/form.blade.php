...
@section('content')
    <form id="formulario-editar">
        ...
        @php
            if($doctipocompra){
                $msg_bt= "Actualizar";
                 $msg_h4= "Editar tipo documento";
            }else{
                 $msg_bt= "Guardar Nuevo regisro";
                  $msg_h4= "Nuevo tipo documento";
            }
        @endphp
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="id" readonly value="{{$doctipocompra->id ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="nombre"   value="{{$doctipocompra->nombre  ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                @php
                                    if($doctipocompra){
                                        $activo= ($doctipocompra->activo==1)?'checked="checked"': '';
                                    }else{
                                        $activo='';
                                    }
                                @endphp
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-danger btn-sm" href="{{route('admin.general.doctipocompra')}}">Cancelar</a>
                    </div><!--col-->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery('#formulario-editar').submit(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route('admin.general.doctipocompra.form.update') }}",
                    method: 'post',
