...
@section('content')
    <form id="formulario-editar">
        ...
        @php
            if($impresora){
                $msg_bt= "Actualizar";
                 $msg_h4= "Editar impresora";
                 $readonly = "readonly";
            }else{
                 $msg_bt= "Guardar Nuevo regisro";
                  $msg_h4= "Nueva impresora";
                  $readonly = "";
        ...
        <div class="card">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="id" readonly value="{{$impresora->id ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="nombre"  {{$readonly}} value="{{$impresora->nombre  ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->

                        <div class="form-group row">
                            <label class="col-md-2 form-control-label" for="nombre">Key</label>

                            <div class="col-md-10">
                                <input type="text" class="form-control" name="key"   value="{{$impresora->key  ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
                            ...
                            <div class="col-md-10">
                                ...
                                if(!$impresora){
                                    $activo= 'checked="checked"';
                                     ...
                                     if($impresora){
                                        $activo= ($impresora->activo==1)?'checked="checked"': '';
                                     }else{
                                        $activo='';
                                     }
                                }
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-danger btn-sm" href="{{route('admin.general.impresora')}}">Cancelar</a>
                    </div><!--col-->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery('#formulario-editar').submit(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route('admin.general.impresora.form.update') }}",
                    method: 'post',
