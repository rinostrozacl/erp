            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                        <a href="{{ route('admin.general.doctipoventa.form') }}" class="btn btn-success ml-1" data-toggle="tooltip" title="@lang('labels.general.create_new')"><i class="fas fa-plus-circle"></i> Nuevo</a>
                    </div><!--btn-toolbar-->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            var tabla= $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin.general.doctipoventa.tabla')}}',
                columns: [
                    {data: 'id', name: 'id'},
            ...
            jQuery('#datatable tbody').on( "click", ".bt-desactivar",function(){
                ...
                jQuery.ajax({
                    url: "{{ route('admin.general.doctipoventa.activar') }}",
                    method: 'post',
                    data: { id: id},
            ...
            jQuery('#datatable tbody').on( "click", ".bt-eliminar",function(){
                ...
                //alert('aa'+ id);
                jQuery.ajax({
                    url: "{{ route('admin.general.doctipoventa.eliminar') }}",
                    method: 'post',
                    data: { id: id},
                    success: function(data){
                        if(data.estado==1){
