    ...
    <form id="formulario-editar">
        ...
        <div class="card">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="id" readonly value="{{$doctipoventa->id ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="nombre"   value="{{$doctipoventa->nombre  ?? ''}}">
                            </div><!--col-->
                        </div><!--form-group-->
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-danger btn-sm" href="{{route('admin.general.doctipoventa')}}">Cancelar</a>
                    </div><!--col-->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery('#formulario-editar').submit(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route('admin.general.doctipoventa.form.update') }}",
                    method: 'post',
