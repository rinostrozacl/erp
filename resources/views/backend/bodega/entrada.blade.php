                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                         {{--Columna derecha--}}
                                                ...
                                                {{-- Eliminada clase 'selectpicker' de lista de proveedores. Revisar versión de bootstrap --}}
                    ...
                    success: function (data) {
                       ...
                       $("#producto_id_add").empty();
                        $.each(JSON.parse(data), function(id, item) {
                            $("#producto_id_add").append('<option value=' + item.id + ' title="' +  item.descripcion + '" >' + item.nombre +  " ("+ item.stock_disponible +") (" +item.marca +') </option>');
                        });
